...
Hello and welcome to the final lecture of this course. We will of course see the result of translation and conclude by reviwing how much it costs both in terms of time and money. Additionally we will see how it's possible to delete our API key in case we will not planning to use it for a next time. 

Let me go and see first what is in the folder. Super, I have all my files perfectly translated. Each file has been properly marked with a text index so I know which file means what language.

Now let me go back to my R software to see how much time did it take. Good news that I can simply substract end time from start time and I will be able to learn that it took one and the half hour. What about money? Do I still have any? I will go to my project and I will learn that I have 256 CHF remaining. Which is probably not too bad. Considering time it would take to translate all those files manaully 20 swiss franks are not that big deal. Even if you have to pay that from your own pocket it is still worth to use automated translation. Just remind that we have now 8 different languages. 

What I will also show you now is how to delete your key. Well It's very  intuitive. Simply go ahead and delete it. Because of the fact that you can generate your key any time again it's probably good to know how to delete this key. 

That is it. You have now completed this course. You know that Google translated 23 files to 8 languages. In total we spent 18.4 CHF that is equivalent to exactly 10 cents for each file created...
